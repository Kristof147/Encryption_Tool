...
namespace Encryption_Tool.Service
{
    public static class KeyHelper
    {
        ...
        //Heb deze alleen even apart gezet zodat ik die in de RSAPage ook kan gebruiken om de Aes decrypted key op te slaan
        public static void SaveAesKey(string filePath, Aes aes)
        {
        ...
        public static void SaveKeys(out string publicKey, out string privateKey)
        {
            ...
            if (ofd.ShowDialog() == true)
            {
                ...
                // Genereer een RSA-sleutelpaar
                GenerateRSAKey(out string publickey, out string privatekey);
